        ...
        data: (_indexNum) {
          if (_indexNum != '') {
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (_homeChangeProvider.dropdownSelectedValue !=
                                null) {
                              _checkResult =
            ...
            return Scaffold(
                ...
                // FIXME:目標未設定でFutureProvider起動後、目標設定を完了してもFutureProviderが再発火せず(watchを値の監視がされない)、
                // FIXME: _indexnumが空のままなので、ずっとループ的に設定するページが表示される。
                body: const NewSetup());
          }
        });
  }
